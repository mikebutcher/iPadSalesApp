...
//iPadSalesAppUsers 7-28-14
tlURL = "http://www.chardonlabs.com/CUSKEY.NSF/(json)?ReadViewEntries&count=500&RestrictToCategory=iPadSalesAppUsers&outputformat=json"
...
histURL = "http://www.chardonlabs.com/eReportv4.nsf/iPhoneHistory2?ReadViewEntries&count=2000&RestrictToCategory=" + techname + "&outputformat=json";
...
function addShrinkingList(custid, name) {
    ...
    localDB.transaction(function(tx) {
        tx.executeSql('INSERT INTO ShrinkingList (custid, name) VALUES (?, ?)', [custid, name]);
    });
}
